...
public class SignupThree extends JFrame implements ActionListener {
    ...
    public SignupThree(String formno) {
        ...
        JLabel number = new JLabel("xxxx-xxxx-xxxx-2364");
        ...
        c3.setBounds(100, 415, 200, 30);
        add(c3);
        
        c4 = new JCheckBox("Email and SMS Alerts ");
        c4.setBackground(Color.WHITE);
        c4.setFont(new Font("Raleway", Font.BOLD, 16));
        c4.setBounds(350, 415, 200, 30);
        add(c4);
        ...
        c7 = new JCheckBox("I Hereby declares that teh above enter dataits are corret to the best of my knowledge");
        c7.setBackground(Color.WHITE);
        c7.setFont(new Font("Raleway", Font.BOLD, 15));
        c7.setBounds(100, 490, 700, 30);
        add(c7);
        ...
        cancel.setBounds(420, 560, 150, 30);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource() == submit){
            ...
            if(r1.isSelected()){
                ...
                accountType = "Fixed Deposit Accoount ";
            }
